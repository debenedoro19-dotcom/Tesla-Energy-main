          ...
          <div className="bg-[#121214] border border-[#26262A] rounded-2xl p-6 mb-8">
            ...
            >
              <input
                ...
                className="bg-black border border-[#26262A] rounded-xl px-4 py-3 focus:outline-none focus:border-[#E82127]"
              />
              ...
              <input
                required
                placeholder="Expected Return (e.g. 12–18% p.a.)"
              ...
              <textarea
                ...
                className="md:col-span-2 bg-black border border-[#26262A] rounded-xl px-4 py-3 focus:outline-none focus:border-[#E82127] min-h-[80px]"
              />
              ...
              <textarea
                ...
                className="md:col-span-2 bg-black border border-[#26262A] rounded-xl px-4 py-3 focus:outline-none focus:border-[#E82127] min-h-[100px]"
              />
              ...
              <div className="md:col-span-2 flex gap-3">
                <button
                  type="submit"
                  className="bg-[#E82127] hover:bg-[#FF3B41] text-white px-6 py-2.5 rounded-xl font-semibold"
                >
                ...
                <button
                  type="button"
                  onClick={resetForm}
                  className="border border-[#26262A] px-6 py-2.5 rounded-xl"
                >
                  Cancel
                </button>
              </div>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            ...
            {list.map((item) => (
              <div
                key={item.id}
                className="bg-[#121214] border border-[#26262A] rounded-xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4"
              >
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    {item.highlighted && (
                      <span className="text-xs bg-[#E82127] px-2 py-0.5 rounded">
                        Popular
                      </span>
                    )}
                  ...
                  <div className="text-sm text-[#6E6E73]">
                    ${item.minAmount.toLocaleString()} min ·{" "}
                    {item.expectedReturn} · {item.duration}
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="text-xs border border-[#26262A] px-3 py-1.5 rounded-lg hover:border-white"
                  >
                    Edit
                  </button>
                  ...
                  <button
                    ...
                    className="text-xs text-red-400 px-3 py-1.5 rounded-lg"
                  >
                    Delete
                  </button>
                </div>
