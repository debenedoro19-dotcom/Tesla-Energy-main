  ...
  return (
    <div className="relative min-h-screen bg-[#050508] text-white overflow-x-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/cybertruck.jpg')",
          backgroundAttachment: "fixed",
          filter: "brightness(0.35) contrast(1.15) saturate(0.85)",
        }}
      />
      {/* Dark gradient veils */}
      <div className="fixed inset-0 -z-20 bg-gradient-to-r from-[#050508] via-[#050508]/85 to-[#050508]/55" />
      <div className="fixed inset-0 -z-20 bg-gradient-to-b from-[#050508]/40 via-transparent to-[#050508]" />
      {/* Cyan tech grid */}
      <div
        className="fixed inset-0 -z-10 opacity-[0.12] pointer-events-none"
        style={{
          backgroundImage: `
            linear-gradient(rgba(0, 217, 255, 0.35) 1px, transparent 1px),
            linear-gradient(90deg, rgba(0, 217, 255, 0.35) 1px, transparent 1px)
          `,
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-20 -right-20 w-[420px] h-[420px] md:w-[560px] md:h-[560px] rounded-full bg-[#E82127]/25 blur-[100px] opacity-60 animate-pulse" />
        <div
          className="absolute bottom-0 -left-16 w-[380px] h-[380px] md:w-[480px] md:h-[480px] rounded-full bg-cyan-400/20 blur-[90px] opacity-50 animate-pulse"
          style={{ animationDelay: "1.4s" }}
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full bg-[#E82127]/[0.08] blur-[120px]" />
        <div
          className="absolute top-[20%] left-[30%] w-[200px] h-[200px] rounded-full bg-cyan-300/15 blur-[60px] opacity-40 animate-pulse"
          style={{ animationDelay: "0.7s" }}
        />
        {/* Particles */}
        <div className="absolute top-[18%] left-[10%] w-1.5 h-1.5 rounded-full bg-[#E82127] shadow-[0_0_12px_#E82127] animate-float" />
        <div className="absolute top-[35%] right-[14%] w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_14px_#22d3ee] animate-float-delayed" />
        <div className="absolute bottom-[28%] left-[22%] w-1 h-1 rounded-full bg-white/80 shadow-[0_0_8px_#fff] animate-float" />
        <div className="absolute top-[60%] right-[28%] w-1.5 h-1.5 rounded-full bg-[#E82127]/90 shadow-[0_0_10px_#E82127] animate-float-delayed" />
        <div className="absolute top-[48%] left-[55%] w-1 h-1 rounded-full bg-cyan-300/80 shadow-[0_0_8px_#67e8f9] animate-float" />
      </div>

      {/* HEADER */}
      <header
        className={`fixed top-0 left-0 right-0 z-50 h-[72px] flex items-center justify-between px-6 md:px-10 transition-all duration-500 ${
          scrolled
            ? "bg-black/70 backdrop-blur-2xl border-b border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)]"
            : "bg-transparent border-b border-white/5"
        }`}
      >
        <Link href="/" className="flex items-center gap-3 font-bold text-xl tracking-tight">
          <div className="w-9 h-9 bg-gradient-to-br from-[#E82127] to-[#9b1020] rounded-lg flex items-center justify-center text-white font-extrabold text-lg shadow-[0_0_20px_rgba(232,33,39,0.5)]">
            T
          </div>
          <span className="bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Tesla Trade</span>
        </Link>

        <nav className="hidden lg:flex items-center gap-6">
          {["Buy", "Inventory", "Invest", "Giveaways", "Market", "VIP"].map((label) => (
            <a
              key={label}
              href={`#${label === "Buy" ? "buy" : label === "Invest" ? "investments" : label === "VIP" ? "vip" : label.toLowerCase()}`}
              className="text-sm font-medium tracking-widest uppercase text-white/50 hover:text-cyan-300 transition relative group"
            >
              {label}
              <span className="absolute -bottom-1 left-0 w-0 h-px bg-gradient-to-r from-cyan-400 to-[#E82127] group-hover:w-full transition-all duration-300" />
            </a>
          ))}
          <button
            onClick={openVipModal}
            className="relative bg-gradient-to-r from-[#E82127] via-[#FF3B41] to-[#E82127] text-white px-5 py-2.5 rounded-full text-sm font-semibold tracking-wide transition hover:shadow-[0_0_30px_rgba(232,33,39,0.55)] hover:scale-105"
          >
            Meet Elon
          </button>
          <Link href="/login" className="text-sm font-medium text-white/50 hover:text-white transition">Login</Link>
          <Link href="/signup" className="text-sm font-medium border border-white/15 bg-white/5 hover:border-cyan-400/50 hover:text-cyan-300 px-4 py-2 rounded-full transition backdrop-blur-sm">
            Sign Up
          </Link>
        </nav>

        <button onClick={openVipModal} className="lg:hidden bg-[#E82127] text-white px-4 py-2 rounded-full text-sm font-semibold shadow-[0_0_20px_rgba(232,33,39,0.4)]">
          Meet Elon
        </button>
      </header>

      {/* HERO */}
      <section id="buy" className="relative min-h-screen pt-36 pb-24 px-6 md:px-10 max-w-[1440px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/30 text-cyan-300 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase mb-6 shadow-[0_0_20px_rgba(34,211,238,0.15)]">
            <span className="w-1.5 h-1.5 rounded-full bg-cyan-400 animate-pulse" />
            Powered by Tesla Ecosystem
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-[3.9rem] font-extrabold leading-[1.05] tracking-tight mb-6">
            {s.heroTitle.includes("Tomorrow") ? (
              <>
                Trade Tesla{" "}
                <span className="bg-gradient-to-r from-[#E82127] via-[#ff6b6f] to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(232,33,39,0.3)]">
                  Tomorrow
                </span>
              </>
            ) : (
              <span className="bg-gradient-to-r from-white via-cyan-100 to-[#E82127] bg-clip-text text-transparent">
                {s.heroTitle}
              </span>
            )}
          </h1>

          <p className="text-white/60 text-lg max-w-md mb-8 leading-relaxed">{s.heroSubtitle}</p>
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            {[
              ...
              <div
                key={stat.label}
                className="rounded-xl px-5 py-4 min-w-[120px] border border-white/10 bg-white/[0.06] backdrop-blur-xl
                           hover:border-cyan-400/40 hover:shadow-[0_0_25px_rgba(34,211,238,0.12)] hover:-translate-y-0.5 transition-all duration-300"
              >
                <div className="text-2xl font-bold bg-gradient-to-r from-[#E82127] to-cyan-400 bg-clip-text text-transparent">
                  {stat.value}
                </div>
                <div className="text-[11px] text-white/40 uppercase tracking-wide mt-1">{stat.label}</div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            <button
              ...
              className="relative px-8 py-3.5 rounded-xl font-semibold text-white overflow-hidden
                         bg-gradient-to-r from-[#E82127] via-[#FF3B41] to-[#E82127]
                         shadow-[0_0_30px_rgba(232,33,39,0.35)]
                         hover:shadow-[0_0_45px_rgba(232,33,39,0.55)] transition-all duration-300 hover:scale-[1.03]
            ...
            <button
              onClick={openVipModal}
              className="border border-cyan-400/30 bg-cyan-400/5 backdrop-blur-sm hover:border-cyan-400/60 hover:bg-cyan-400/10 hover:text-cyan-200 text-white px-8 py-3.5 rounded-xl font-semibold transition-all duration-300"
            >
          ...
          <div className="flex flex-wrap gap-6 text-sm text-white/45">
            {["Bank-grade Security", "Real-time Pricing", "Instant Settlement"].map((t) => (
              <span key={t} className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-[#E82127] to-cyan-400 shadow-[0_0_6px_#E82127]" />
                {t}
              </span>
            ))}
          </div>
        ...
        <div className="relative flex justify-center">
          ...
          <div className="absolute inset-0 m-auto w-[85%] h-[85%] rounded-full bg-gradient-to-br from-[#E82127]/20 via-transparent to-cyan-400/20 blur-3xl" />
          <div className="relative w-full max-w-[540px] rounded-2xl overflow-hidden border border-white/15
                          shadow-[0_25px_80px_-15px_rgba(0,0,0,0.8),0_0_60px_rgba(232,33,39,0.15),0_0_40px_rgba(34,211,238,0.08)]
                          group">
            <Image
              src="/cybertruck.jpg"
            ...
            <div className="absolute bottom-5 left-1/2 -translate-x-1/2 bg-black/60 backdrop-blur-2xl border border-white/15 rounded-xl px-6 py-3.5 flex gap-8 min-w-[280px] shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
              <div>
                <div className="text-[11px] text-white/40 uppercase tracking-wide">Current Price</div>
                <div className="text-xl font-bold text-white">$45,230</div>
              </div>
              <div>
                <div className="text-[11px] text-white/40 uppercase tracking-wide">24h Change</div>
      ...
      <section id="inventory" className="max-w-[1440px] mx-auto px-6 md:px-10 py-16">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition ${
                invFilter === cat
                  ...
                  : "bg-white/5 border border-white/10 text-[#B0B0B5] hover:border-[#E82127] backdrop-blur-sm"
              }`}
            >
              {cat}
              {cat !== "All" && (
        ...
        {loadingData ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl h-48 animate-pulse" />
            ))}
          </div>
        ) : (
          (() => {
            ...
            return (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                {filtered.map((item) => (
                  <div
                    key={item.id}
                    className="group relative rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent backdrop-blur-xl overflow-hidden hover:border-[#E82127]/45 hover:shadow-[0_0_40px_rgba(232,33,39,0.18)] hover:-translate-y-1 transition-all duration-500"
                  >
                    {/* Product visual */}
      ...
      <section id="giveaways" className="max-w-[1440px] mx-auto px-6 md:px-10 py-16">
        ...
        {loadingData ? (
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {giveaways.map((gw) => (
              <div key={gw.id} className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent backdrop-blur-xl p-7 hover:border-[#E82127]/45 hover:shadow-[0_0_40px_rgba(232,33,39,0.15)] transition-all duration-500 overflow-hidden">
                ...
                <button
                  onClick={() => openGiveawayModal(gw)}
                  className="relative w-full py-3 rounded-xl font-semibold text-white overflow-hidden
                             bg-gradient-to-r from-[#E82127] via-[#FF3B41] to-[#E82127]
                             hover:shadow-[0_0_30px_rgba(232,33,39,0.45)] transition-all duration-300
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-10 pb-16 grid md:grid-cols-3 gap-5">
        {[
          ...
          <Link key={cat.title} href={cat.href} className="group relative block rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent backdrop-blur-xl p-7 hover:border-[#E82127]/45 hover:shadow-[0_0_40px_rgba(232,33,39,0.15)] hover:-translate-y-1 transition-all duration-500 overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#E82127] to-transparent opacity-0 group-hover:opacity-100 transition" />
        ...
        {loadingData ? (
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {investments.map((pkg) => (
              <div
                key={pkg.id}
                className={`relative rounded-2xl p-7 transition-all duration-500 hover:-translate-y-1 backdrop-blur-xl overflow-hidden ${
                  pkg.highlighted
                    ? "border border-[#E82127] bg-gradient-to-b from-[#E82127]/15 via-white/5 to-transparent shadow-[0_0_40px_rgba(232,33,39,0.2)]"
                    : "border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent hover:border-[#E82127]/45 hover:shadow-[0_0_40px_rgba(232,33,39,0.15)]"
                }`}
              >
                {pkg.highlighted && (
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-xl font-semibold transition ${
                    pkg.highlighted
                      ? "relative overflow-hidden bg-gradient-to-r from-[#E82127] via-[#FF3B41] to-[#E82127] text-white hover:shadow-[0_0_30px_rgba(232,33,39,0.45)] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-700"
                      : "border border-white/15 bg-white/5 hover:border-[#E82127] hover:text-[#E82127]"
                  }`}
                >
                  Apply Now
                </button>
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-10 py-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {portfolio.map((item) => (
            <div key={item.id} className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-xl p-5 hover:border-[#E82127]/35 transition">
      ...
      <section id="payments" className="max-w-[1440px] mx-auto px-6 md:px-10 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {payments.map((pay) => (
            <div key={pay.id} className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6 hover:border-[#E82127]/40 transition-all duration-300">
      ...
      <section id="market" className="max-w-[1440px] mx-auto px-6 md:px-10 py-16">
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-xl px-5 py-3.5 mb-8 flex items-center gap-4 overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            ...
            <div key={stock.symbol} className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6 hover:border-[#E82127]/35 hover:-translate-y-0.5 transition-all duration-300">
      ...
      <section id="vip" className="max-w-3xl mx-auto px-6 py-10">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent backdrop-blur-xl p-10 md:p-12 text-center relative overflow-hidden shadow-[0_0_60px_rgba(232,33,39,0.08)]">
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#E82127] to-transparent" />
          ...
          <button
            ...
            className="relative px-8 py-3.5 rounded-xl font-semibold text-white overflow-hidden
                       bg-gradient-to-r from-[#E82127] via-[#FF3B41] to-[#E82127]
                       hover:shadow-[0_0_35px_rgba(232,33,39,0.5)] transition-all duration-300 hover:scale-[1.03]
                       before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/25 before:to-transparent
                       before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-700"
          >
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-10 py-20">
        ...
        {loadingData ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {testimonials.map((t) => (
              <div key={t.id} className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 via-white/5 to-transparent backdrop-blur-xl p-6 hover:border-[#E82127]/40 hover:shadow-[0_0_30px_rgba(232,33,39,0.12)] hover:-translate-y-1 transition-all duration-500">
                <div className="flex items-center gap-3 mb-4">
                  <img
      ...
      <section id="contact" className="text-center py-24 px-6">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          ...
          <button
            onClick={openVipModal}
            className="border border-white/15 bg-white/5 backdrop-blur-sm hover:border-[#E82127] hover:text-[#E82127] px-8 py-3.5 rounded-xl font-semibold transition"
          >
            Book Session
          </button>
        </div>
      ...
      {modalType && (
        ...
        >
          <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#1a1a1c] via-[#121214] to-[#0c0c0e] backdrop-blur-xl p-8 max-w-md w-full relative my-8 shadow-2xl shadow-black/50">
